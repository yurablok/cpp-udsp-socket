...
//
// Designed for real-time data transmission through reliable and partially
// reliable (unreliable with ordering) streams with different priorities.
// A simple but efficient alternative to QUIC, SCTP, etc.
//
// Author: Yurii Blok
// License: MIT
